...
### 6. **Tester l'Indisponibilité des Serveurs Web**

#### Cas 1 : Indisponibilité de `web1`

1. **Arrêter le serveur `web1`** :
...
2. **Tester le Load Balancer** :
   ...
   - Accédez au load balancer via votre navigateur :
     ```
     http://localhost:8083
     ```
   - Actualisez la page plusieurs fois.
   - Vérifiez que toutes les requêtes sont redirigées vers `web2`.

3. **Redémarrer `web1` une fois le test terminé** :
   ```bash
   vagrant up web1
   ```
...
#### Cas 2 : Indisponibilité de `web2`

1. **Arrêter le serveur `web2`** :
...
2. **Tester le Load Balancer** :
   ...
   - Accédez au load balancer via votre navigateur :
     ...
     ```
   - Actualisez la page plusieurs fois.
   - Vérifiez que toutes les requêtes sont redirigées vers `web1`.

3. **Redémarrer `web2` une fois le test terminé** :
   ```bash
   vagrant up web2
   ```
